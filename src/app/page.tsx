        ...
        <div className="bg-gray-100 pt-4 pb-2">
          ...
          <div className="max-w-screen-lg mx-auto px-5">
            <div className="mb-6 lg:mb-12 text-center">
              <h2 className="text-2xl lg:text-4xl text-gray-900 pb-2 lg:pb-4 font-bold">
                🎁75% OFF SALE🎁 Gia
              </h2>
              ...
              <div className="lg:mt-4 text-sm lg:text-xl md:px-20 py-3 lg:py-4 text-gray-800">
                Get exclusive access to my content and interact with me
                directly.
                <br />
                <p className="mt-2 lg:mt-4 text-sm lg:text-xl pt-3 text-gray-800">
                  🍑 💦 Do you live near{" "}
            ...
            <div className="flex flex-row justify-center">
              <button className="bg-sky-400 hover:bg-sky-500 text-white font-bold py-3 lg:py-6 px-16 lg:px-72 rounded-3xl">
                <a
                  href="https://onlyfans.com/giannawildin"
            ...
            <div className="mt-2 lg:mt-4 text-md lg:text-xl md:px-20 font-bold text-sky-400 text-center">
              <p>
                {" "}
                Get access to my private account now! Only $3.00/m for a limited
                time!
              </p>
            </div>
          </div>
